...
public enum Control {
	...
	public static boolean prilogflag = false;
	public static boolean adminlogflag = false;
	Start start;
	...
	private class PrivateHandler implements EventHandler<ActionEvent> {
		public void handle(ActionEvent evt) {
			...
			if(prilogflag){
				...
				RequestLoginHandler loginPage = new RequestLoginHandler();
				loginPage.handle(evt);
